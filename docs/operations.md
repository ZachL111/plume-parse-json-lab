...
`plume-parse-json-lab` is centered on parsers work in Ruby. The technical target is: Implement a Ruby parsers project for json stream reduction, using windowed input fixtures and late-data behavior checks.
...
The score is deterministic. The current threshold is 151. Risk has a penalty of 6, latency has a penalty of 3, and weight contributes a bonus of 6.
